    ...
    <Link href={href} className="group block">
      <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 transition-all duration-300 hover:border-secondary hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]">
        ...
        <div className="aspect-square w-full relative overflow-hidden">
          {/* Usiamo img standard per semplicità, ma puoi usare next/image se hai configurato i domini */}
          <img
            src={imageUrl}
            alt={name}
          ...
          <div className="absolute top-2 right-2 bg-black/70 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded-full border border-gray-600">
            {abv}% ABV
          </div>
          {isKhmer && (
            <div className="absolute bottom-2 right-2 bg-blue-500/90 px-1 py-1 rounded-full  border-red-600 border-4">
