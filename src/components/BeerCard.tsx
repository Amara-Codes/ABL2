...
// Definiamo un tipo props ridotto per la card
type BeerCardProps = {
  id: number;
  name: string;
  category: string;
  ...
  return (
      ...
      <div className="bg-gray-900 rounded-xl overflow-hidden border border-gray-800 transition-all duration-300 hover:border-secondary hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]">
        ...
        <div className="aspect-square w-full relative overflow-hidden">
          ...
          <Image
            src={imageUrl}
            alt={name}
            fill // Riempie il contenitore padre (che ha aspect-square)
            className="object-cover transition-transform duration-500 group-hover:scale-110"
            // sizes aiuta il browser a scegliere l'immagine giusta. 
            // Traduzione: "Su mobile occupa tutto lo schermo, su tablet metà, su desktop un terzo o un quarto"
          ...
          {isKhmer && (
            <div className="absolute bottom-2 right-2 bg-blue-500/90 px-1 py-1 rounded-full border-red-600 border-4 z-10">
              ...
              <svg fill="#ffffff" height="32" width="32" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 463.833 463.833" xmlSpace="preserve">
                <g>
    ...
    C356.496,242.702,358.556,243.552,360.667,243.552z"/>
        ...
        <div className="p-4">
          ...
          <h3 className="text-white font-fatboy text-xl leading-tight group-hover:text-secondary transition-colors">
            {name}
          </h3>
        </div>
      </div>
