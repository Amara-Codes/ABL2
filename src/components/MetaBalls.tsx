...
const MetaBalls = ({
  ...
  useEffect(() => {
    ...
    type BallParam = { st: number; dtFactor: number; baseScale: number; toggle: number; radius: number };
  ...
  return <div ref={containerRef} className={`metaballs-container relative w-full h-full ${className}`} />;
};
